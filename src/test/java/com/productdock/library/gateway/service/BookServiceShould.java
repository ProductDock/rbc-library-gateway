...
class BookServiceShould {
    ...
    private static final Mono<RentalRecordsDto> RENTAL_RECORDS_DTO_MONO = Mono.just(defaultRentalRecordsDto());
    ...
    void generateBookDetailsDto() {
        ...
        given(responseCombiner.generateBookDetailsDto(defaultBookDto(), defaultRentalRecordsDto(), AVAILABLE_BOOK_COUNT)).willReturn(BOOK_DETAILS_DTO_MONO);
